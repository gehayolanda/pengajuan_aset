            ...
            <div class="card shadow-none border border-warning mb-3">
                <div class="card-body p-4">
                    <h5 class="fw-semibold mb-3 text-warning">
                        <i class="ti ti-clipboard-check me-1"></i> Validasi Pengajuan
                    </h5>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label text-success fw-medium" for="setuju">
                                        Disetujui
                                    </label>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label text-danger fw-medium" for="tolak">
                                        Ditolak
                                    </label>
                                </div>
                            </div>
